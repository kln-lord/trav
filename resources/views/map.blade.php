            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        ...
                        <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="http://localhost/project/home.php">Home</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div style="font-size: 1rem;color:#1a1a1a;marging-top:10px;margin-bottom:30px;">Explore the world based on your location : <form class="form-horizontal form-material mx-2" method="POST" action="/getLocation">@csrf<input class = "form-control form-control-line" type="text" id="origin" @if(!empty($data)) value = "{{$data->cityName}}" @endif name='location' style = "padding-top:12px !important;font-size:0.8rem;width:200px;margin-top:-40px;margin-left:320px;position:absolute" style="scale: 0.8"><button class="btn btn-success" style="margin-top:-30px;margin-left:540px;position:absolute;scale:0.8">submit</button></form></div>
                            <script @if(empty($location)) src="https://tp.media/content?trs=216990&shmarker=418774&lat=30.378326&lng=-9.555895&powered_by=true&search_host=www.aviasales.com%2Fsearch&locale=en&currency=usd&origin=AGA&value_min=0&value_max=1000000&round_trip=true&only_direct=false&radius=1&draggable=true&disable_zoom=false&show_logo=false&scrollwheel=false&primary=%231A1A1a&secondary=%231A1A1a&light=%23ffffff&width=1500&height=500&zoom=2&promo_id=4054&campaign_id=100" @else src="https://tp.media/content?trs=216990&shmarker=418774&lat=30.378326&lng=-9.555895&powered_by=true&search_host=www.aviasales.com%2Fsearch&locale=en&currency=usd&origin={{$location}}&value_min=0&value_max=1000000&round_trip=true&only_direct=false&radius=1&draggable=true&disable_zoom=false&show_logo=false&scrollwheel=false&primary=%231A1A1a&secondary=%231A1A1a&light=%23ffffff&width=1500&height=500&zoom=2&promo_id=4054&campaign_id=100" @endif  charset="utf-8"></script>
